...
<head>
    ...
    <title>Beca Aceita Namorar Comigo?</title>
</head>

<body>
    <div id="conteudo">
        <h2> Beca Aceita namorar comigo?</h2>
...
<script>
    function sim() {
        alert("Te Amo, Aperta em ok");
        // redireciona para um URL após clicar no SIM
        location.href = "https://open.spotify.com/intl-pt/track/47Slg6LuqLaX0VodpSCvPt?si=61116f7c75754d8f";
    }
